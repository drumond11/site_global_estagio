<footer class="py-2 bg-body-secondary">
    <div class="container">
        <div class="row text-center d-flex align-items-center">
            <div class="col-lg">
                <a href="#" data-bs-toggle="modal" data-bs-target="#meuModal">Centros de Resolução de
                    Litígios</a>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="row text-center d-flex align-items-center">
            <div class="col-lg">
                <ul class="horizontal">
                    <li class="hidden-sm-down social-networks-container">
                        <a href="https://d31imo.blogspot.com/" target="_blank">
                            <i class="fa-brands fa-blogger"></i>
                        </a>
                        &nbsp;
                        <a href="https://www.facebook.com/profile.php?id=61556990467849" target="_blank">
                            <i class="fa-brands fa-facebook-f"></i>
                        </a>
                        &nbsp;
                        <a href="https://www.instagram.com/d31imo/" target="_blank">
                            <i class="fa-brands fa-square-instagram"></i>
                        </a>
                        &nbsp;
                        <a href="https://www.tiktok.com/@d31imo" target="_blank">
                            <i class="fa-brands fa-tiktok"></i>
                        </a>
                        &nbsp;
                        <a href="https://twitter.com/d31imo" target="_blank">
                            <i class="fa-brands fa-twitter"></i>
                        </a>
                        &nbsp;
                        <a href="https://api.whatsapp.com/send/?phone=%2B967924403&text&type=phone_number&app_absent=0"
                            target="_blank">
                            <i class="fa-brands fa-whatsapp"></i>
                        </a>
                        &nbsp;
                        <a href="https://www.youtube.com/@D31imo" target="_blank">
            ...
            <div class="col-lg">
                <p class="my-auto">&copy; Copyright
                    <?php echo date('Y'); ?> D31
                </p>
            </div>
            <div class="col-lg" style="display: none;">
                <p class="my-auto">v1.0.4</p>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="meuModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Centros de Resolução de Litígios</h5>
                </div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-4NKCDXXVVL"></script>
<script> window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); } gtag('js', new Date()); gtag('config', 'G-4NKCDXXVVL'); </script>
</body>
